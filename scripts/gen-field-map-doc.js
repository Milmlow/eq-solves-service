...
const pmAssetFields = [
  ...
  ['Show Site Overview', 'tenant_settings.report_show_site_overview', ''],
  ['Show Contents', 'tenant_settings.report_show_contents', ''],
  ['Show Exec Summary', 'tenant_settings.report_show_executive_summary', ''],
  ['Show Sign-off', 'tenant_settings.report_show_sign_off', ''],
...
const children = [
  ...
  note('Generated from: /api/pm-report — simpler check-level report with pass/fail summary and item list. No per-asset breakdown.'),
