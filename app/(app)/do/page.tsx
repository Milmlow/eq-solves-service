...
import {
  FileSpreadsheet, Upload, Zap, ClipboardPaste,
...
const SECTIONS: DoSection[] = [
  {
    ...
    tiles: [
      ...
      {
        label: 'Paste work orders',
        description: 'Paste a table from an email or spreadsheet — Asset ID + WO number is all you need.',
        href: '/maintenance/paste',
        icon: ClipboardPaste,
        visibleTo: 'admin-supervisor',
      },
      {
